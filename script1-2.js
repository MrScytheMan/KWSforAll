...
if (typeof GAME === 'undefined') { } else {
	...
	Array.from(document.getElementsByTagName('script')).forEach(script => {
        ...
        class kwsv3 {
            ...
            loadRiddles(cb) {
                fetch(`https://raw.githubusercontent.com/MrScytheMan/KWSforAll/main/riddles.json`).then(res => res.json()).then((out) => {
                    cb(out)
                }).catch(err => {
                    throw err
                });
            ...
            bindClickHandlers() {
                ...
                $("body").on("click", ".qlink.load_afo", () => {
                    if (typeof this.afo_is_loaded == 'undefined') {
                        ...
                        $.get("https://raw.githubusercontent.com/MrScytheMan/KWSforAll/main/uncodedeeee.js", (data) => {
