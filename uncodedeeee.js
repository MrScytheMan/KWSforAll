...
*/
            var PVP = {
                ...
                route: [1,1,1,1,1,1,1,1,1,2,3,4,2,3,4,2,3,4,1],
                startTime: false,
                routeIndex: 0,
                routeStart: true,
                adimp: false,
            ...
            PVP.run = async () => {
                while (!PVP.stop) {
                    ...
                    if (await PVP.wait_next_round()) continue;
            ...
            PVP.kill_players = async () => {
                while (true) {
                    const $loadMoreBtn = $("button[data-option='load_more_players']:visible");
