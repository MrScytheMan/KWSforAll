    ...
    let Pgg = setInterval(() => {
        ...
        class kwsv3 {
            constructor(charactersManager) {
                ...
                $(`<div id="bonusMenu"> <div><b>Wybierz bonusy:</b></div> ${this.generateBonusSelects(4)} <div><b>Wybierz ID Peta:</b></div> <select id="petIdSelect"> ${this.generatePetOptions()} </select> <button id="startButton">Start</button> </div>`)
