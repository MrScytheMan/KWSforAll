            ...
            markDaily() {
                ...
                $('#quest_track_con .qtrack b').each(function () {
                    ...
                    if (daily.includes(zawartoscB)) {
                        const qtrackElement = $(this).closest('.qtrack');
                        if (!qtrackElement.hasClass('sep3')) {
                            $(this).css("color", "#63aaff");
                            lastSep3Element.append(qtrackElement.clone());
                            qtrackElement.remove();
                        }
                    }
                });
                ...
                $('[id^="track_quest_"]').each(function () {
                    ...
                    const qtrackElement = $(this).closest('.qtrack');
                    if (questLoc === currentLocation && !qtrackElement.hasClass('sep3')) {
